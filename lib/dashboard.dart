              ...
              return ListView(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      _vehicle("Bus", FontAwesomeIcons.bus, 500, 1),
                      _vehicle("Truck", FontAwesomeIcons.truck, 1500, 2),
                    ],
                  ),
                  SizedBox(
                    height: 20,
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceAround,
                    children: [
                      _vehicle("Car", FontAwesomeIcons.car, 250, 3),
                      _vehicle("Pickup", FontAwesomeIcons.truckPickup, 750, 4),
                    ],
                  ),
                  SizedBox(
                    height: 20,
